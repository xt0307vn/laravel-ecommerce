                ...
                <div class="accordion" id="size-filters">
                    <div class="accordion-item mb-4 pb-3">
                        ...
                        <div id="accordion-filter-size" class="accordion-collapse collapse show border-0" aria-labelledby="accordion-heading-size" data-bs-parent="#size-filters">
                            <div class="accordion-body px-0 pb-0">
                                <div class="d-flex flex-wrap">
                                    <a href="#" class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">
                                        XS
                                    </a>
                                    <a href="#" class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">S
                                    </a>
                                    <a href="#" class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">M
                                    </a>
                                    <a href="#" class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">L
                                    </a>
                                    <a href="#" class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 js-filter">
                                        XL
                                    </a>
            ...
            <div class="shop-list flex-grow-1">
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
                        ...
                        <a href="{{ route("shop.index") }}" class="menu-link menu-link_us-s text-uppercase fw-medium">
                            The Shop
                        </a>
                    </div>
                        ...
                        <div class="product-card-wrapper">
                            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ route("shop.product.detail", $product->slug) }}">
                                                    <img loading="lazy" src="{{ asset("uploads/product") }}/{{$product->image}}" width="330" height="400" alt="{{ $product->name }}" class="pc__img">
                                                </a>
                                            </div>
                                            @if($product->images)
                                                @foreach(explode(",", $product->images) as $reviewImg)
                                                    <div class="swiper-slide">
                                                        <a href="{{ route("shop.product.detail", $product->slug) }}">
                                                            <img loading="lazy" src="{{ asset("uploads/product") }}/{{$reviewImg}}" width="330" height="400" alt="{{ $product->name }}" class="pc__img">
                                                        </a>
                                                    </div>
                                                @endforeach
                                            @endif
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <h6 class="pc__title">
                                        <a href="{{ route("shop.product.detail", $product->slug) }}">{{ $product->name }}</a>
                                    </h6>
