                    ...
                    <div class="product-single__media" data-media-type="vertical-thumbnail">
                        ...
                        <div class="product-single__thumbnail">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{ asset("uploads/product") }}/{{ $product->image }}" width="104" height="104" alt="{{ $product->name }}"/>
                                    </div>
                                    @foreach(explode(",", $product->images) as $gimg)
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto" src="{{ asset("uploads/product") }}/{{ $gimg }}" width="104" height="104" alt="{{ $product->name }}"/>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        @foreach($related_products as $related_product)
                            <div class="swiper-slide product-card">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route("shop.product.detail", $related_product->slug) }}">
                                        <img loading="lazy" src="{{ asset('uploads/product') }}/{{ $related_product->image }}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                        @foreach(explode(",", $related_product->images) as $rgimg)
                                            <img loading="lazy" src="{{ asset('uploads/product') }}/{{ $rgimg }}" width="330" height="400" alt="{{ $related_product->name }}" class="pc__img pc__img-second">
                                        @endforeach
                                    </a>
                                    @if(Cart::instance("cart")->content()->where("id", $product->id)->count() > 0)
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <h6 class="pc__title">
                                        <a href="details.html">{{ $related_product->name }}</a>
                                    </h6>
