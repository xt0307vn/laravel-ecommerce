                ...
                <div class="wg-box">
                    ...
                    <div class="gap22 cols">
                        ...
                        <fieldset class="brand">
                            <div class="body-title mb-10">Brand
                                <span class="tf-color-1">*</span>
                            </div>
                            <div class="select">
                    ...
                    <fieldset class="shortdescription">
                        ...
                        <textarea class="mb-10 ht-150" name="short_description" value="{{ $product->short_description }}"
                    ...
                    <fieldset class="description">
                        ...
                        <textarea class="mb-10" name="description" value="{{ $product->description }}"
                                  placeholder="Description" tabindex="0" aria-required="true" required="">{{ $product->description }}</textarea>
                        <div class="text-tiny">Do not exceed 100 characters when entering the product name.</div>
                    </fieldset>
                    @error('description')
                    <span class="alert alert-danger text-center">{{ $message }}</span>
                        ...
                        <div class="upload-image flex-grow">
                            @if($product->image)
                                <div class="item" id="imgpreview">
                                    <img src="{{ asset("uploads/product") }}/{{ $product->image }}" class="effect8" alt="Preview">
                                </div>
                            @endif
